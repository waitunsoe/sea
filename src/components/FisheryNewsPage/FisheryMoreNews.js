...
import FisheryMostReadNews from "./FisheryMostReadNews";
import FisheryNews from "./FisheryNews";

const FisheryMoreNews = () => {
  return (
...
export default FisheryMoreNews;
