import FisheryMostReadNewsImg from "../../assets/images/fishery-news-4.png";

const FisheryMostReadNews = () => {
  return (
    <article className="">
...
export default FisheryMostReadNews;
